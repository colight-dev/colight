...
from colight_publish.static.builder import build_directory


def build_examples():
    """Generate various colight-publish examples in test-artifacts for manual inspection."""

    # Get paths
    test_dir = pathlib.Path(__file__).parent
    examples_dir = test_dir / "examples"
    project_root = test_dir.parent.parent.parent  # Go up 3 levels to project root
    artifacts_dir = project_root / "test-artifacts" / "colight-publish"
