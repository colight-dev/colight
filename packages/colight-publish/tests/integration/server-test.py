#!/usr/bin/env python3
"""
Integration test that runs the actual colight-publish server
...
def start_server(test_dir, port=5555):
    """Start the colight-publish server watching the test directory."""
...
def main():
    ...
    try:
        ...
        # Start server
        print("\nStarting colight-publish server...")
        port = 5555
