...
This document tracks all identified issues with the test suite in the colight-publish package, categorizing them by priority and type.
...
- **Files affected**: `colight_publish/json_api.py` (ApiMiddleware)
...
- **Files affected**: `colight_publish/server.py`, `colight_publish/incremental_executor.py`
...
- **Proposed structure**:
  ...
  │   ├── live/       # Tests for colight_publish modules
  │   ├── site/       # Tests for colight_publish modules
  │   └── static/     # Tests for colight_publish.static modules
