...
def watch_and_build(
    ...
    if input_path.is_file():
        builder.build_file(input_path, output_path, verbose=verbose)
    else:
        builder.build_directory(input_path, output_path, verbose=verbose)
                ...
                if input_path.is_file():
                    ...
                    for changed_file in colight_changes:
                        if changed_file.is_relative_to(input_path):
                            ...
                            builder.build_file(
                                changed_file, output_file, verbose=verbose
                            )
