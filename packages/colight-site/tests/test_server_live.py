...
from colight_static.server_watch import HtmlFallbackMiddleware, LiveReloadServer
...
def temp_site(tmp_path):
    ...
    test_artifacts_dir = tmp_path / "test-artifacts" / "colight-site"
...
async def test_live_reload_server_sends_reload_signal(temp_site):
    ...
    with patch("colight_static.server_watch.awatch", mock_awatch):
        with patch.object(
