...
from colight_live.block_graph import BlockGraph
...
def test_star_import_with_usage():
    ...
    provides1, requires1 = analyze_block_dependencies(code1)

    # Block 2: uses something that might come from the star import
    code2 = "result = sin(pi / 2)"
    provides2, requires2 = analyze_block_dependencies(code2)
