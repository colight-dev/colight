...
"""
    ...
    build_file(
        example1_path,
        artifacts_dir / "01_basic_numpy.html",
        verbose=True,
        format="html",
    )
...
"""
    ...
    build_file(
        example2_path,
        artifacts_dir / "02_multiple_viz.html",
        verbose=True,
        format="html",
    )
...
"""
    ...
    build_file(
        example3_path,
        artifacts_dir / "03_data_analysis.html",
        verbose=True,
        format="html",
    )
...
'''
    ...
    build_file(
        example4_path,
        artifacts_dir / "04_math_exploration.html",
        verbose=True,
        format="html",
    )
...
"""
    ...
    build_file(
        example5_path,
        artifacts_dir / "05_mixed_content.html",
        verbose=True,
        format="html",
    )
...
1. **01_basic_numpy** - Simple numpy visualization example (.md and .html)
2. **02_multiple_viz** - Multiple visualizations in one document (.md and .html)
3. **03_data_analysis** - Complete data analysis workflow (.md and .html)
4. **04_math_exploration** - Mathematical function exploration (.md and .html)
5. **05_mixed_content** - Mixed content with various data types (.md and .html)
