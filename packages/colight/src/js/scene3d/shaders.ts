...
// Group transform struct for GPU-based group transforms
export const groupTransformStruct = /*wgsl*/ `
...
fn applyGroupTransformNormal(normal: vec3<f32>, idx: u32) -> vec3<f32> {
  let t = transforms[idx];
  return quat_rotate(t.quaternion, normal);
}`;
